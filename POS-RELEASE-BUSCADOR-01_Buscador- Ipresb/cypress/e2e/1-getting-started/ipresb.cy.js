describe('Buscador Ipresb (São Paulo) e (Rio Janeiro)', () => {
  

  it('Consultorios e Clinicas - Por Local',() =>{
    cy.visit("https://portalbdhml.bdconnect.com.br/portal/?op=16#!/rede")
  
  cy.get('input#AutoCompleteAddress')
  .type('São Paulo, SP, Brasil{downarrow}{enter}', { delay: 300 })
   cy.wait(3000)
  ...
  it('Pronto Socorro - Por Local',() =>{
    ...
    cy.get('input#AutoCompleteAddress')
    .type('Rio de Janeiro, RJ, Brasil{downarrow}{enter}', { delay: 300 })
     cy.wait(3000)
  ...
  cy.get('#NomeCredenciado').type('CLINICA');
   cy.wait(3000)
   cy.get('#cbEstado').select('object:44');
   cy.wait(3000)
   cy.get('b').click();
   cy.wait(3000)
   cy.get('.chosen-search > input').clear();
   cy.wait(3000)
   cy.get('.chosen-search > input').type('rio de ');
   cy.wait(3000)
  ...
  it('Pronto Socorro - Por Nome',() =>{
    ...
    cy.visit("https://portalbdhml.bdconnect.com.br/portal/?op=16#!/rede")
    cy.get(':nth-child(2) > .col-lg-12 > :nth-child(2) > .checkbox > label').click({force:true})
    cy.get(':nth-child(2) > .col-lg-12 > :nth-child(2) > .checkbox > label').click();
    // Nome do crecendicado
    cy.get('#NomeCredenciado').type('CLINICA');
     cy.wait(3000)
